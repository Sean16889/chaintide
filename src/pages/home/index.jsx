    ...
    <div className='flex-1 flex flex-col'>
      <div ref={positionRef} className='centerblock  h-[600px] xl:h-[927px] 2xl:h-[927px] w-full flex justify-center items-center'>
          <div className='mt-[10px] px-[15px] xl:mt-[75px] 2xl:mt-[75px]'>
              <StyledGradientText className=' w-full text-[40px]/[48px] xl:text-[64px]/[70px] 2xl:text-[64px]/[70px] xl:w-[755px] 2xl:w-[755px]'>
                  ChainTide surges,Follow the trend.
              </StyledGradientText>
              <Desc className='mt-[10px] xl:mt-[30px] 2xl:mt-[30px] mb-[30px] xl:mb-[79px] 2xl:mb-[79px] text-sm  xl:text-base/[20px] 2xl:text-base/[20px]'>One-stop covering media, communities, on-chain funds and global resources</Desc>
              <CenterBtn className='mt-[18px] xl:mt-[30px] 2xl:mt-[30px]  xl:px-[31px] xl:py-[18px] 2xl:px-[31px] 2xl:py-[18px]  hover:grow text-base xl:text-[18px] 2xl:text-[18px] font-medium'>
                  <a href='https://t.me/weljoar' className='text-black' target='_blank'>Apply Now →</a> 
              </CenterBtn>
