...
export default function FlowContent() {
  return (
    <div className='mx-auto pt-[95px] pb-[131px] lg:pl-[24px]'>
        <div className='flex flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-between w-[175px] lg:w-[430px] xl:w-[484px] 2xl:w-[484px] '>
            <FlowContentBlock className='flex-1 mr-0  lg:mr-[15px] xl:mr-[17px] 2xl:mr-[17px] p-[17px]'>
            ...
            <div>
                <FlowContentBlock className='lg:h-[66px]  xl:h-[74px] 2xl:h-[74px] flex items-center p-[17px] mb-[10px] xl:mb-[22px] 2xl:mb-[22px]'>
                    <img src={ChineseIcon} className='w-[14px] h-[14px]' />
                    <div className='w-[111px]'>
                        <p className='text-center text-[#C5C5C5] text-[16px]'>Chinese Community</p>
                    </div>
                </FlowContentBlock>
                <FlowContentBlock className='lg:h-[66px]  xl:h-[74px] 2xl:h-[74px] flex items-center p-[17px]'>
        ...
        <div className=' lg:w-[430px] xl:w-[484px] 2xl:w-[484px] mt-[22px] lg:mt-[33px]'> 
            <FlowContentBlock className='flex-1 p-[17px] px-2'>
                <div className='flex items-center flex-col lg:flex-row xl:flex-row 2xl:flex-row'>
                    <img src={Vuesax} className='w-[36px] h-[36px] lg:w-[32px] lg:h-[32px]' />
